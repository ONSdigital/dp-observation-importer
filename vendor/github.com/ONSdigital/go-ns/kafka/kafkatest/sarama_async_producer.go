...
// SaramaAsyncProducerMock is a mock implementation of SaramaAsyncProducer.
//
//     func TestSomethingThatUsesSaramaAsyncProducer(t *testing.T) {
//
//         // make and configure a mocked SaramaAsyncProducer
//         mockedSaramaAsyncProducer := &SaramaAsyncProducerMock{ 
//             AsyncCloseFunc: func()  {
// 	               panic("TODO: mock out the AsyncClose method")
//             },
...
// 	               panic("TODO: mock out the Successes method")
//             },
//         }
//
//         // TODO: use mockedSaramaAsyncProducer in code that requires SaramaAsyncProducer
...
func (mock *SaramaAsyncProducerMock) AsyncClose()  {
	if mock.AsyncCloseFunc == nil {
		panic("moq: SaramaAsyncProducerMock.AsyncCloseFunc is nil but SaramaAsyncProducer.AsyncClose was just called")
	}
	callInfo := struct {
	}{
	}
...
func (mock *SaramaAsyncProducerMock) Close() error {
	if mock.CloseFunc == nil {
		panic("moq: SaramaAsyncProducerMock.CloseFunc is nil but SaramaAsyncProducer.Close was just called")
	}
	callInfo := struct {
	}{
	}
...
func (mock *SaramaAsyncProducerMock) Errors() <-chan *sarama.ProducerError {
	if mock.ErrorsFunc == nil {
		panic("moq: SaramaAsyncProducerMock.ErrorsFunc is nil but SaramaAsyncProducer.Errors was just called")
	}
	callInfo := struct {
	}{
	}
...
func (mock *SaramaAsyncProducerMock) Input() chan<- *sarama.ProducerMessage {
	if mock.InputFunc == nil {
		panic("moq: SaramaAsyncProducerMock.InputFunc is nil but SaramaAsyncProducer.Input was just called")
	}
	callInfo := struct {
	}{
	}
...
func (mock *SaramaAsyncProducerMock) Successes() <-chan *sarama.ProducerMessage {
	if mock.SuccessesFunc == nil {
		panic("moq: SaramaAsyncProducerMock.SuccessesFunc is nil but SaramaAsyncProducer.Successes was just called")
	}
	callInfo := struct {
	}{
	}
